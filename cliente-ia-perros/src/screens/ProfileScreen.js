...
const ProfileScreen = () => {
  ...
  const renderAchievement = ({ id, title, desc, icon, iconColor, iconBg }) => (
    <View key={id} style={styles.achievementRow}>
      <View style={[styles.achievementIconContainer, { backgroundColor: iconBg }]}>
    ...
    >
      ...
      <View style={styles.profileCard}>
        ...
        <View style={styles.statsRow}>
          {PROFILE_STATS.map(renderStatItem)}
        </View>
      </View>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>
          <Ionicons name="heart-outline" size={12} color="#9FB3C8" /> 
          PetSense v1.0 · Hecho para perritos
        </Text>
      </View>
    </ScrollView>
  );
